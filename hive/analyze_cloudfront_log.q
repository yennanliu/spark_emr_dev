...
) LOCATION 's3://cloudfront-hadoop/data/';

-- Total requests per operating system for a given time frame
INSERT OVERWRITE DIRECTORY 's3://cloudfront-hadoop/hive_output/' SELECT os, COUNT(*) count FROM cloudfront_logs WHERE dateobject BETWEEN '2014-07-05' AND '2014-08-05' GROUP BY os;